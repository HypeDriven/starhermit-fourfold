/* Fourfold — seeded random streams.
 * UMD: usable from the browser (window.FFRNG) and Node (require).
...
(function (root, factory) {
  ...
  function streams(masterSeed) {
    return {
      ...
      ai: derive(masterSeed, STREAM_AI)
    };
  }
